  ...
  return (
    <div className="min-h-screen bg-[#0F172A]">
      ...
      <div className="px-8 py-8">
        ...
        {/* Developer Tools */}
        <div className="mt-8 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl border border-slate-700 shadow-xl p-6">
          <h3 className="text-lg font-semibold text-white mb-2">Developer Tools</h3>
          <p className="text-sm text-slate-400 mb-6">Scan for HIPAA violations everywhere you write code.</p>
...
{/* vlayer:rule-count-cli:start — generated by scripts/sync-rule-counts.mjs, do not edit */}
              <p className="text-xs text-slate-400 mb-3">143 rules. Scan any directory from your terminal.</p>
{/* vlayer:rule-count-cli:end */}
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                <svg className="w-5 h-5 text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.583 2.293L12 7.876 6.417 2.293 2 4.707v14.586l4.417 2.414L12 16.124l5.583 5.583L22 19.293V4.707l-4.417-2.414z" />
                </svg>
                <span className="font-medium text-white">VS Code Extension</span>
              </div>
              <p className="text-xs text-slate-400 mb-3">Real-time scanning, inline diagnostics, and quick fixes as you code.</p>
              <code className="text-xs text-blue-400 bg-slate-900 px-2 py-1 rounded">ext install vlayer.vlayer-hipaa</code>
            </div>
            {/* GitHub Action */}
            <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-white">GitHub Action</span>
              </div>
              <p className="text-xs text-slate-400 mb-3">Automated PR checks. Block non-compliant code before merge.</p>
              <code className="text-xs text-purple-400 bg-slate-900 px-2 py-1 rounded">uses: vlayer/hipaa-scan@v1</code>
            </div>
          </div>
        </div>
      </div>
