...
<!-- vlayer:rule-count-intro:start — generated by scripts/sync-rule-counts.mjs, do not edit -->
vlayer checks your code against 143 rules (137 pattern-based + 6 AI-powered) across the 5 HIPAA compliance categories:
<!-- vlayer:rule-count-intro:end -->
